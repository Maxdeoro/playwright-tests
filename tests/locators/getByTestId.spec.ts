...
test.describe('General tests for getByTestId()', () => {
  ...
  test('Get header of the page', async ({ page }) => {
  ...
  test('Get all buttons add-to-cart', async ({ page }) => {
...
test.describe('Tests for forms and buttons', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('https://osstep.github.io/locator_getbytestid');
  });

  // Задание 1: Найди карточку продукта по test-id и проверь её содержимое
  test('Get and check product card', async ({ page }) => {
  ...
  test('Get and fill order form', async ({ page }) => {
...
test.describe('Complex cases for getByTestId()', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('https://osstep.github.io/locator_getbytestid');
  });
  ...
  test('Check footer of the page', async ({ page }) => {
