...
test.describe('General tests for getByAltText()', () => {
  ...
  test('Get image by alt-text', async ({ page }) => {
  ...
  test('Get logo of the company', async ({ page }) => {
...
test.describe('Tests for dynamic images', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('https://osstep.github.io/locator_getbyalttext');
  });
  ...
  test('Get dynamic loaded image', async ({ page }) => {
  ...
  test('Get all icons by part of alt-text', async ({ page }) => {
