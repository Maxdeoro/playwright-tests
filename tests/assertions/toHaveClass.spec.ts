...
test('Test the initial class of the element', async ({ page }) => {
...
test('Test classes switching', async ({ page }) => {
...
test('Test to show/hide an element', async ({ page }) => {
...
test('Test classes of the user card', async ({ page }) => {
...
test('Testing an element with multiple classes', async ({ page }) => {
  ...
  const changeBtn = page.getByRole('button', {name: 'Изменить классы'});
